...
class ActivityTokens(object):
    ...
    def __init__(self, type=None, count=None):  # noqa: E501
        """ActivityTokens - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def count(self):
        """Gets the count of this ActivityTokens.  # noqa: E501

        How many tokens have been awarded to the learner for the type  # noqa: E501

        :return: The count of this ActivityTokens.  # noqa: E501
        :rtype: int
        """
        return self._count
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ActivityTokens):
            return False
