...
class TestPageStateController(BaseTestCase):
    """PageStateController integration test stubs"""
    ...
    def test_delete_page_state(self):
        ...
        response = self.client.open(
            '/rui-support/page-state/{keycloakId}'.format(keycloakId='keycloakId_example'),
            method='DELETE',
