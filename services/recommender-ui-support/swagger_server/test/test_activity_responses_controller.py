...
class TestActivityResponsesController(BaseTestCase):
    """ActivityResponsesController integration test stubs"""
    ...
    def test_delete_activity_response(self):
        ...
        response = self.client.open(
            '/rui-support/activity-responses/{activityId}'.format(activityId='activityId_example'),
            method='DELETE',
