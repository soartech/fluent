...
class AllApi(object):
    ...
    def all_get(self, learner_id, **kwargs):  # noqa: E501
        """Get all activities  # noqa: E501

        Returns all activities.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.all_get(learner_id, async=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async'):
            return self.all_get_with_http_info(learner_id, **kwargs)  # noqa: E501
        else:
            (data) = self.all_get_with_http_info(learner_id, **kwargs)  # noqa: E501
            return data

    def all_get_with_http_info(self, learner_id, **kwargs):  # noqa: E501
        """Get all activities  # noqa: E501

        Returns all activities.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.all_get_with_http_info(learner_id, async=True)
        >>> result = thread.get()
        ...
        if ('learner_id' not in params or
            ...
            raise ValueError("Missing the required parameter `learner_id` when calling `all_get`")  # noqa: E501
